...
if ($ip_ok==1)
        ...
        if ($number == -1)
                    ...
                    $number_of_line=0;
                    $path_in="../public_html/testing/t_0/"; $file_in=$path_in."test.txt";
                    ...
                    open(user_file,">>../public_html/testing/results/t_0/".$username.".vop");
                    ...
                    open(user_file,">>../public_html/testing/results/t_0/".$username.".tim");
                    print user_file "$^T\n";
                    close(user_file);
                    #Создание файла username.txt
                    open(user_file,">>../public_html/testing/results/t_0/".$username.".txt");
                    close(user_file);
                    #Создание файла username.res
                    open(user_file,">>../public_html/testing/results/t_0/".$username.".res");
                    close(user_file);
        ...
        if ($quest_quantity -$number >=0)
                ...
                open(UFILE,"../public_html/testing/results/t_0/".$username.".vop");
                @fromfile=<UFILE>;
                chop(@fromfile);
                close(UFILE);
                $first_number = $fromfile[$number]; 
                $path_in="../public_html/testing/t_0/";
                ...
                $name_out="../public_html/testing/results/t_0/".$username.".txt";
                ...
                print "\n<form  action='../cgi-bin/t_0.pl' method='get'>\n";
...
#                print "<input type = hidden  name = '01_question_01' value='$question'>\n";
                ...
                $example="https://raw.githubusercontent.com/g00u00/g06u28/main/010_html/030_images/perl.gif";
                $example_1="https://raw.githubusercontent.com/g00u00/g06u28/main/010_html/030_images/hse30.png";
                print "\n<pre>
...
При создании форм использовать правила умолчания и данные должны отправляться  на удаленный сервер.
...
#                print FILE_OUT $question,"    ", $corr_answer,"    ",$answer,"    ",$picture_img, "\n";
        ...
        #-------------------------------------------------
          if ($quest_quantity -$number < 100 )
               { 
                $name_in="../public_html/testing/results/t_0/".$username.".txt";
                open FILE_IN,$name_in or die "mistake-$name_in" ;
                $name_out="../public_html/testing/results/t_0/".$username.".res";
                open (FILE_OUT, ">",$name_out) || die"mistake-$name_out";
                $n_i = -1;
                $corr_numb=0;
                while ($pri = <FILE_IN>)
...
#для запрета на просмотр строку выше расскомменировать  
                        {
                            $name_in="../public_html/testing/results/t_0/".$username.".res";
...
#                                print"\n",$n_bl;
        ...
        #                                ($question, $corr_answer, $answer,$picture_img) =split(/\t/, $pri, 4);
                                        ...
                                        print "\n<table width=400 cellpadding=0 border=1 bgcolor=silver>";
                                        print "<tr><td width=50% ></td><td></td><td  width=40% ></td></tr>"; #разметка ячеек
