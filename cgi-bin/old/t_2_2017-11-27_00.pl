...
if ($remote_address eq "85.140.3.29"  or $remote_address eq "46.229.141.88" or $remote_address eq "194.190.181.222")
		{
		$query_str =~ tr/+/ /;
...
<br>Строку для таблицы создавать в контексте всей таблицы (проанализировать  количество строк и столбцов) и отправлять только ряд (начинать с tr  в угловых скобках)  
<br>Строку для параграфа следует  начинать с p  в угловых скобках
