...
if ($remote_address eq "46.229.141.81"  or $remote_address eq "194.190.181.147" or $remote_address eq "194.190.181.148")
#$my_ip=$control_ip=$remote_address;
#для доступа отовсюду строку выше раскомменировать 
