...
$quest_quantity_enter=8;   #!!!!___Ввести количество вопросов
...
if ($remote_address eq "46.229.141.81"  or $remote_address eq "46.229.141.80" or $remote_address eq "46.229.141.88")
    {
		$query_str =~ tr/+/ /;
		...
		if ($number == -1)
					...
					$number_of_line=0;
					$path_in="../public_html/testing/t_8/"; #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		...
		if ($quest_quantity -$number >=0)
				...
				print "\n<form  action='../cgi-bin/t_8.pl' method='get'>\n";
...
#				print "<input type = hidden  name = '01_question_01' value='$question'>\n";
				...
				$example_picture="http://ed.nn2000.info/public_html/testing/testing.gif";	
				print "</n 
<p>Ответ записать в одну строку
...
<br>Строку для таблицы создавать в контексте всей таблицы и начинать с tr  в угловых скобках 
<br>Строку для блока следует  начинать с div  в угловых скобках
<br>Если нужно изображение, можно использовать: $example_picture</p>
";
