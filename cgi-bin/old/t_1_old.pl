...
#				print "<input type = hidden  name = '01_question_01' value='$question'>\n";
				...
				print "</n <p>Ответ записать в одну строку<br>Строку для таблицы следует  начинать с tr  в угловых скобках <br>Строку для абзаца следует  начинать с p  в угловых скобках<br>Если нужно изображение, можно использовать:$example</p>";
