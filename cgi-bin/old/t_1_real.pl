...
$my_ip="89.189.16.120"; # IP к-ра, с которого доступ на тестирование Вышка
...
#$my_ip=$remote_address;#если доступ разрешен с любого к-ра - строку раскомментировать
#!  Менять выше !
		...
		#								($question, $corr_answer, $answer,$picture_img) =split(/\t/, $pri, 4);
										...
										if ($answer eq $corr_answer)#
											...
											$corr_quantity=$corr_quantity+1;
												...
												else {print "<br><font color='Red'><B>Оценивается преподавателем</B></font>";}
										print "<HR>";
									}
								}
						}
